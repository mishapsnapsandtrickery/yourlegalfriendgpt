...
st.write(
    "복잡한 계약서를 아주 쉽게! GPT가 중요한 조항을 요약해드립니다."
)
...
각 조항 밑에 한줄로 중요한 내용 요약해. 이때, 요약된 내용은 초등학생 수준에서도 알아들을 수 있도록 쉽게 설명해줘.
법적 위험(일방 면책, 위약금, 자동 갱신 등)은 ⚠️로 강조. 법을 잘 모르는 일반인이 주의해야 할 위험 조항이 있으면 꼭 알려줘.
